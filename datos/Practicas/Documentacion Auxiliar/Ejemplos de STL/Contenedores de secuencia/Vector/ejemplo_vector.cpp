...
int main()
{
 ...
 vector <double> w1(10);
  ...
  if (v1.empty())
    cout << "El vector v1 está vacío" << endl;
  else
    cout << "El vector v1 no está vacío" << endl;


  if (w1.empty())
    cout << "El vector w1 está vacío" << endl;
  else
    cout << "El vector w1 no está vacío" << endl;
 

  cout << "La longitud máxima del vector de enteros v1 es: " << v1.max_size() << endl;

  cout << "La longitud máxima del vector de reales w1 es: " << w1.max_size() << endl;


  cout << "La longitud actual del vector de enteros v1 es: " << v1.size() << endl;

  cout << "La longitud actual del vector de reales w1 es: " << w1.size() << endl;
  ...
  cout << "La longitud actual del vector de enteros v2 es: " << v2.size() << endl;
 ...
 /// Uso de iteradores
  ...
  cout << "\n Funciones específicas de vector: capacity y reserve  " << endl << endl;
 
  cout << " v1.capacity() --> " <<  v1.capacity() << endl;
  cout << " v1.reserve(21)" << endl;
  v1.reserve(21);
...
/////////////////////
  ...
  cout << "\n remove << no >> funciona correctamente con vectores" << endl;
 ...
 cout << "\n ***************************** " << endl ;
  ...
  cout << "\n remove_if << no >> funciona correctamente con vectores" << endl;
  cout << " v1 ";
  for_each(v1.begin(),v1.end(),imprimir);
  cout << endl;
 ...
 cout << "\n ***************************** " << endl ;
  ...
  cout << "\n unique << no >> funciona correctamente con vectores" << endl;
  cout << " v1 ";
  for_each(v1.begin(),v1.end(),imprimir);
  cout << endl; 
